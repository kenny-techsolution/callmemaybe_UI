onMouseoverUnknown : function(chart) {
		var popup = $(".ethnicity-chart.chartContainer .unknown_popup");
...
afterRendering: function(chart)
{
	...
	$(".ethnicity-chart.chartContainer").append("<div class='unknown_popup'><div class='unknown_label'>Unknown Ethnicity:</div>" +
	...
	$unknownText.find("tspan").attr("x", 164);
	...
	var onClick = function(elements) {
		return function() {
			...
			var $unknownStatus = $(".ethnicity-chart.chartContainer .unknown_status");
